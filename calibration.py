...
def f_r(architecture,pose,command):
    ...
    f1 = pow(x1 - (a1[0]+l11*numpy.cos(q1)),2) + pow(x2 - (a1[1]+l12*numpy.sin(q1)), 2) - pow(l12,2)
    f2 = pow(x1 - (a2[0]+l21*numpy.cos(q1)),2) + pow(x2 - (a2[1]+l22*numpy.sin(q2)), 2) - pow(l21,2)
    return [f1,f2]
